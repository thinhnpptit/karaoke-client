...
CREATE TABLE `tbldiachi` (
  ...
  `tinhthanh` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tbldiachi` VALUES (1,'1','nguyen van troi','mo lao','ha dong','ha noi'),(2,'2','tran phu','mo lao','ha dong','ha noi'),(3,'3','nguyen van loc','mo lao','ha dong','ha noi'),(4,'4','nguyen trai','thanh xuan','thanh xuan','ha noi');
